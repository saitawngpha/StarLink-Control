...
public object TransceiverIFLoopbackTestResponseKt {
  ...
  @kotlin.PublishedApi
    ...
    public var berLoopbackTest: kotlin.Float
      @kotlin.jvm.JvmName("getBerLoopbackTest")
        get() = _builder.berLoopbackTest
      @kotlin.jvm.JvmName("setBerLoopbackTest")
        set(value) {
    ...
    public var snrLoopbackTest: kotlin.Float
      @kotlin.jvm.JvmName("getSnrLoopbackTest")
        get() = _builder.snrLoopbackTest
      @kotlin.jvm.JvmName("setSnrLoopbackTest")
        set(value) {
    ...
    public var rssiLoopbackTest: kotlin.Float
      @kotlin.jvm.JvmName("getRssiLoopbackTest")
        get() = _builder.rssiLoopbackTest
      @kotlin.jvm.JvmName("setRssiLoopbackTest")
        set(value) {
    ...
    public var pllLock: kotlin.Boolean
      @kotlin.jvm.JvmName("getPllLock")
        get() = _builder.pllLock
      @kotlin.jvm.JvmName("setPllLock")
        set(value) {
