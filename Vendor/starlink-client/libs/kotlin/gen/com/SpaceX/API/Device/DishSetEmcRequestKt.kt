...
public object DishSetEmcRequestKt {
  ...
  @kotlin.PublishedApi
    ...
    public var rxChan: kotlin.Int
      @kotlin.jvm.JvmName("getRxChan")
        get() = _builder.rxChan
      @kotlin.jvm.JvmName("setRxChan")
        set(value) {
    ...
    public var txChan: kotlin.Int
      @kotlin.jvm.JvmName("getTxChan")
        get() = _builder.txChan
      @kotlin.jvm.JvmName("setTxChan")
        set(value) {
    ...
    public var modulation: kotlin.Int
      @kotlin.jvm.JvmName("getModulation")
        get() = _builder.modulation
      @kotlin.jvm.JvmName("setModulation")
        set(value) {
    ...
    public var desiredTiltAngle: kotlin.Double
      @kotlin.jvm.JvmName("getDesiredTiltAngle")
        get() = _builder.desiredTiltAngle
      @kotlin.jvm.JvmName("setDesiredTiltAngle")
        set(value) {
    ...
    public var chanOverride: kotlin.Boolean
      @kotlin.jvm.JvmName("getChanOverride")
        get() = _builder.chanOverride
      @kotlin.jvm.JvmName("setChanOverride")
        set(value) {
    ...
    public var thetaEnabled: kotlin.Boolean
      @kotlin.jvm.JvmName("getThetaEnabled")
        get() = _builder.thetaEnabled
      @kotlin.jvm.JvmName("setThetaEnabled")
        set(value) {
    ...
    public var phiEnabled: kotlin.Boolean
      @kotlin.jvm.JvmName("getPhiEnabled")
        get() = _builder.phiEnabled
      @kotlin.jvm.JvmName("setPhiEnabled")
        set(value) {
    ...
    public var idle: kotlin.Boolean
      @kotlin.jvm.JvmName("getIdle")
        get() = _builder.idle
      @kotlin.jvm.JvmName("setIdle")
        set(value) {
        _builder.idle = value
      }
    /**
    ...
    public var fastSwitching: kotlin.Boolean
      @kotlin.jvm.JvmName("getFastSwitching")
        get() = _builder.fastSwitching
      @kotlin.jvm.JvmName("setFastSwitching")
        set(value) {
    ...
    public var skySearch: kotlin.Boolean
      @kotlin.jvm.JvmName("getSkySearch")
        get() = _builder.skySearch
      @kotlin.jvm.JvmName("setSkySearch")
        set(value) {
    ...
    public var snowActiveOverride: kotlin.Boolean
      @kotlin.jvm.JvmName("getSnowActiveOverride")
        get() = _builder.snowActiveOverride
      @kotlin.jvm.JvmName("setSnowActiveOverride")
        set(value) {
    ...
    public var manualTilting: kotlin.Boolean
      @kotlin.jvm.JvmName("getManualTilting")
        get() = _builder.manualTilting
      @kotlin.jvm.JvmName("setManualTilting")
        set(value) {
