...
public object RadioStatsKt {
  ...
  @kotlin.PublishedApi
    ...
    public var thermalStatus: com.SpaceX.API.Device.RadioStats.ThermalStatus
      @kotlin.jvm.JvmName("getThermalStatus")
        get() = _builder.thermalStatus
      @kotlin.jvm.JvmName("setThermalStatus")
        set(value) {
    ...
    public var antennaStatus: com.SpaceX.API.Device.RadioStats.AntennaStatus
      @kotlin.jvm.JvmName("getAntennaStatus")
        get() = _builder.antennaStatus
      @kotlin.jvm.JvmName("setAntennaStatus")
        set(value) {
  ...
  @kotlin.PublishedApi
      ...
      @kotlin.Deprecated(message = "Field temp is deprecated") public var temp: kotlin.Int
        @kotlin.jvm.JvmName("getTemp")
          get() = _builder.temp
        @kotlin.jvm.JvmName("setTemp")
          set(value) {
          _builder.temp = value
        }
      /**
      ...
      public var temp2: kotlin.Double
        @kotlin.jvm.JvmName("getTemp2")
          get() = _builder.temp2
        @kotlin.jvm.JvmName("setTemp2")
          set(value) {
      ...
      public var powerReduction: kotlin.Int
        @kotlin.jvm.JvmName("getPowerReduction")
          get() = _builder.powerReduction
        @kotlin.jvm.JvmName("setPowerReduction")
          set(value) {
      ...
      public var dutyCycle: kotlin.Int
        @kotlin.jvm.JvmName("getDutyCycle")
          get() = _builder.dutyCycle
        @kotlin.jvm.JvmName("setDutyCycle")
          set(value) {
  ...
  @kotlin.PublishedApi
      ...
      public var rssi1: kotlin.Float
        @kotlin.jvm.JvmName("getRssi1")
          get() = _builder.rssi1
        @kotlin.jvm.JvmName("setRssi1")
          set(value) {
      ...
      public var rssi2: kotlin.Float
        @kotlin.jvm.JvmName("getRssi2")
          get() = _builder.rssi2
        @kotlin.jvm.JvmName("setRssi2")
          set(value) {
      ...
      public var rssi3: kotlin.Float
        @kotlin.jvm.JvmName("getRssi3")
          get() = _builder.rssi3
        @kotlin.jvm.JvmName("setRssi3")
          set(value) {
      ...
      public var rssi4: kotlin.Float
        @kotlin.jvm.JvmName("getRssi4")
          get() = _builder.rssi4
        @kotlin.jvm.JvmName("setRssi4")
          set(value) {
