...
public object SetTestModeRequestKt {
  ...
  @kotlin.PublishedApi
    ...
    public var rfModeValue: kotlin.Int
      @kotlin.jvm.JvmName("getRfModeValue")
        get() = _builder.rfModeValue
      @kotlin.jvm.JvmName("setRfModeValue")
        set(value) {
    ...
    public var disableLossOfCommFdir: kotlin.Boolean
      @kotlin.jvm.JvmName("getDisableLossOfCommFdir")
        get() = _builder.disableLossOfCommFdir
      @kotlin.jvm.JvmName("setDisableLossOfCommFdir")
        set(value) {
    ...
    public var enableRulesOverride: kotlin.Boolean
      @kotlin.jvm.JvmName("getEnableRulesOverride")
        get() = _builder.enableRulesOverride
      @kotlin.jvm.JvmName("setEnableRulesOverride")
        set(value) {
