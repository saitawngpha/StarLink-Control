...
public object MeshConfigKt {
  ...
  @kotlin.PublishedApi
    ...
    public var applyDisplayName: kotlin.Boolean
      @kotlin.jvm.JvmName("getApplyDisplayName")
        get() = _builder.applyDisplayName
      @kotlin.jvm.JvmName("setApplyDisplayName")
        set(value) {
    ...
    public var authValue: kotlin.Int
      @kotlin.jvm.JvmName("getAuthValue")
        get() = _builder.authValue
      @kotlin.jvm.JvmName("setAuthValue")
        set(value) {
    ...
    public var applyAuth: kotlin.Boolean
      @kotlin.jvm.JvmName("getApplyAuth")
        get() = _builder.applyAuth
      @kotlin.jvm.JvmName("setApplyAuth")
        set(value) {
    ...
    public var lastConnected: kotlin.Long
      @kotlin.jvm.JvmName("getLastConnected")
        get() = _builder.lastConnected
      @kotlin.jvm.JvmName("setLastConnected")
        set(value) {
    ...
    public var supports5GhzHigh: kotlin.Boolean
      @kotlin.jvm.JvmName("getSupports5GhzHigh")
        get() = _builder.supports5GhzHigh
      @kotlin.jvm.JvmName("setSupports5GhzHigh")
        set(value) {
