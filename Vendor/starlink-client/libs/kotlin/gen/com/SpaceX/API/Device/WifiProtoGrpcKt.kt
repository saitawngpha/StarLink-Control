...
public object MeshGrpcKt {
  ...
  public class MeshCoroutineStub @JvmOverloads constructor(
    ...
    override fun build(channel: Channel, callOptions: CallOptions): MeshCoroutineStub = MeshCoroutineStub(channel, callOptions)
     ...
     */
    public fun meshStream(requests: Flow<ToController>, headers: Metadata = Metadata()): Flow<FromController> = bidiStreamingRpc(
      channel,
  ...
  public abstract class MeshCoroutineImplBase(
     ...
     *        it more than once.
     */
    public open fun meshStream(requests: Flow<ToController>): Flow<FromController> = throw StatusException(UNIMPLEMENTED.withDescription("Method SpaceX.API.Device.Mesh.MeshStream is unimplemented"))
