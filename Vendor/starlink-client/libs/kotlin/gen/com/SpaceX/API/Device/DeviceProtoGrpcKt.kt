...
public object DeviceGrpcKt {
  ...
  public class DeviceCoroutineStub @JvmOverloads constructor(
    ...
    override fun build(channel: Channel, callOptions: CallOptions): DeviceCoroutineStub = DeviceCoroutineStub(channel, callOptions)
     ...
     */
    public fun stream(requests: Flow<ToDevice>, headers: Metadata = Metadata()): Flow<FromDevice> = bidiStreamingRpc(
      channel,
     ...
     */
    public suspend fun handle(request: Request, headers: Metadata = Metadata()): Response = unaryRpc(
      channel,
  ...
  public abstract class DeviceCoroutineImplBase(
     ...
     *        it more than once.
     */
    public open fun stream(requests: Flow<ToDevice>): Flow<FromDevice> = throw StatusException(UNIMPLEMENTED.withDescription("Method SpaceX.API.Device.Device.Stream is unimplemented"))
     ...
     */
    public open suspend fun handle(request: Request): Response = throw StatusException(UNIMPLEMENTED.withDescription("Method SpaceX.API.Device.Device.Handle is unimplemented"))
