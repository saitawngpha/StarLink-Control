...
public object DishOutageKt {
  ...
  @kotlin.PublishedApi
    ...
    public var startTimestampNs: kotlin.Long
      @kotlin.jvm.JvmName("getStartTimestampNs")
        get() = _builder.startTimestampNs
      @kotlin.jvm.JvmName("setStartTimestampNs")
        set(value) {
    ...
    public var durationNs: kotlin.Long
      @kotlin.jvm.JvmName("getDurationNs")
        get() = _builder.durationNs
      @kotlin.jvm.JvmName("setDurationNs")
        set(value) {
    ...
    public var didSwitch: kotlin.Boolean
      @kotlin.jvm.JvmName("getDidSwitch")
        get() = _builder.didSwitch
      @kotlin.jvm.JvmName("setDidSwitch")
        set(value) {
