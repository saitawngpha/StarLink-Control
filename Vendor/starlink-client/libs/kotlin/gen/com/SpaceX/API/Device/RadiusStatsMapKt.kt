  ...
  @kotlin.PublishedApi
     ...
     */
     public val radiusStats: com.google.protobuf.kotlin.DslMap<kotlin.String, com.SpaceX.API.Device.RadiusStatsMap.RadiusStats, RadiusStatsProxy>
      @kotlin.jvm.JvmSynthetic
@kotlin.jvm.JvmName("getRadiusStatsMap")
     ...
     * `map<string, .SpaceX.API.Device.RadiusStatsMap.RadiusStats> radius_stats = 1 [json_name = "radiusStats"];`
     */
    @kotlin.jvm.JvmName("putRadiusStats")
...
@kotlin.jvm.JvmName("setRadiusStats")
     ...
     */
    @kotlin.jvm.JvmSynthetic
@kotlin.jvm.JvmName("removeRadiusStats")
    public fun com.google.protobuf.kotlin.DslMap<kotlin.String, com.SpaceX.API.Device.RadiusStatsMap.RadiusStats, RadiusStatsProxy>
     ...
     */
    @kotlin.jvm.JvmSynthetic
@kotlin.jvm.JvmName("putAllRadiusStats")
    public fun com.google.protobuf.kotlin.DslMap<kotlin.String, com.SpaceX.API.Device.RadiusStatsMap.RadiusStats, RadiusStatsProxy>
     ...
     */
    @kotlin.jvm.JvmSynthetic
@kotlin.jvm.JvmName("clearRadiusStats")
    public fun com.google.protobuf.kotlin.DslMap<kotlin.String, com.SpaceX.API.Device.RadiusStatsMap.RadiusStats, RadiusStatsProxy>
      .clear() {
  ...
  @kotlin.PublishedApi
      ...
      public var timeoutCount: kotlin.Int
        @kotlin.jvm.JvmName("getTimeoutCount")
          get() = _builder.timeoutCount
        @kotlin.jvm.JvmName("setTimeoutCount")
          set(value) {
      ...
      public var accessRequestCount: kotlin.Int
        @kotlin.jvm.JvmName("getAccessRequestCount")
          get() = _builder.accessRequestCount
        @kotlin.jvm.JvmName("setAccessRequestCount")
          set(value) {
      ...
      public var accessAcceptCount: kotlin.Int
        @kotlin.jvm.JvmName("getAccessAcceptCount")
          get() = _builder.accessAcceptCount
        @kotlin.jvm.JvmName("setAccessAcceptCount")
          set(value) {
      ...
      public var accessRejectCount: kotlin.Int
        @kotlin.jvm.JvmName("getAccessRejectCount")
          get() = _builder.accessRejectCount
        @kotlin.jvm.JvmName("setAccessRejectCount")
          set(value) {
      ...
      public var accessChallengeCount: kotlin.Int
        @kotlin.jvm.JvmName("getAccessChallengeCount")
          get() = _builder.accessChallengeCount
        @kotlin.jvm.JvmName("setAccessChallengeCount")
          set(value) {
      ...
      public var accountingRequestCount: kotlin.Int
        @kotlin.jvm.JvmName("getAccountingRequestCount")
          get() = _builder.accountingRequestCount
        @kotlin.jvm.JvmName("setAccountingRequestCount")
          set(value) {
      ...
      public var accountingResponseCount: kotlin.Int
        @kotlin.jvm.JvmName("getAccountingResponseCount")
          get() = _builder.accountingResponseCount
        @kotlin.jvm.JvmName("setAccountingResponseCount")
          set(value) {
