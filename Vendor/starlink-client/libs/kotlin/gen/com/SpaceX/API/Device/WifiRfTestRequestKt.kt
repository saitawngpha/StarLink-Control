...
public object WifiRfTestRequestKt {
  ...
  @kotlin.PublishedApi
    ...
    public var numMeasurements: kotlin.Int
      @kotlin.jvm.JvmName("getNumMeasurements")
        get() = _builder.numMeasurements
      @kotlin.jvm.JvmName("setNumMeasurements")
        set(value) {
    ...
    public var mcs2Ghz: kotlin.Int
      @kotlin.jvm.JvmName("getMcs2Ghz")
        get() = _builder.mcs2Ghz
      @kotlin.jvm.JvmName("setMcs2Ghz")
        set(value) {
    ...
    public var mcs5Ghz: kotlin.Int
      @kotlin.jvm.JvmName("getMcs5Ghz")
        get() = _builder.mcs5Ghz
      @kotlin.jvm.JvmName("setMcs5Ghz")
        set(value) {
    ...
    public var mcs5GhzHigh: kotlin.Int
      @kotlin.jvm.JvmName("getMcs5GhzHigh")
        get() = _builder.mcs5GhzHigh
      @kotlin.jvm.JvmName("setMcs5GhzHigh")
        set(value) {
    ...
    public var phyMode2Ghz: kotlin.Int
      @kotlin.jvm.JvmName("getPhyMode2Ghz")
        get() = _builder.phyMode2Ghz
      @kotlin.jvm.JvmName("setPhyMode2Ghz")
        set(value) {
    ...
    public var phyMode5Ghz: kotlin.Int
      @kotlin.jvm.JvmName("getPhyMode5Ghz")
        get() = _builder.phyMode5Ghz
      @kotlin.jvm.JvmName("setPhyMode5Ghz")
        set(value) {
    ...
    public var phyMode5GhzHigh: kotlin.Int
      @kotlin.jvm.JvmName("getPhyMode5GhzHigh")
        get() = _builder.phyMode5GhzHigh
      @kotlin.jvm.JvmName("setPhyMode5GhzHigh")
        set(value) {
