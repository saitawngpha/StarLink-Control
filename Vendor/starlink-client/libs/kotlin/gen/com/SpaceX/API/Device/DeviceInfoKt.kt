...
public object DeviceInfoKt {
  ...
  @kotlin.PublishedApi
    ...
    public var boardRev: kotlin.Int
      @kotlin.jvm.JvmName("getBoardRev")
        get() = _builder.boardRev
      @kotlin.jvm.JvmName("setBoardRev")
        set(value) {
    ...
    public var manufacturedVersion: kotlin.String
      @kotlin.jvm.JvmName("getManufacturedVersion")
        get() = _builder.manufacturedVersion
      @kotlin.jvm.JvmName("setManufacturedVersion")
        set(value) {
    ...
    public var generationNumber: kotlin.Long
      @kotlin.jvm.JvmName("getGenerationNumber")
        get() = _builder.generationNumber
      @kotlin.jvm.JvmName("setGenerationNumber")
        set(value) {
    ...
    public var softwarePartitionsEqual: kotlin.Boolean
      @kotlin.jvm.JvmName("getSoftwarePartitionsEqual")
        get() = _builder.softwarePartitionsEqual
      @kotlin.jvm.JvmName("setSoftwarePartitionsEqual")
        set(value) {
    ...
    public var isDev: kotlin.Boolean
      @kotlin.jvm.JvmName("getIsDev")
        get() = _builder.isDev
      @kotlin.jvm.JvmName("setIsDev")
        set(value) {
    ...
    public var antiRollbackVersion: kotlin.Int
      @kotlin.jvm.JvmName("getAntiRollbackVersion")
        get() = _builder.antiRollbackVersion
      @kotlin.jvm.JvmName("setAntiRollbackVersion")
        set(value) {
    ...
    public var isHitl: kotlin.Boolean
      @kotlin.jvm.JvmName("getIsHitl")
        get() = _builder.isHitl
      @kotlin.jvm.JvmName("setIsHitl")
        set(value) {
    ...
    public var dishCohoused: kotlin.Boolean
      @kotlin.jvm.JvmName("getDishCohoused")
        get() = _builder.dishCohoused
      @kotlin.jvm.JvmName("setDishCohoused")
        set(value) {
