...
public object AckSuppressionKt {
  ...
  @kotlin.PublishedApi
    ...
    public var ackMark: kotlin.Int
      @kotlin.jvm.JvmName("getAckMark")
        get() = _builder.ackMark
      @kotlin.jvm.JvmName("setAckMark")
        set(value) {
    ...
    public var htbAckQueueRate: kotlin.Float
      @kotlin.jvm.JvmName("getHtbAckQueueRate")
        get() = _builder.htbAckQueueRate
      @kotlin.jvm.JvmName("setHtbAckQueueRate")
        set(value) {
    ...
    public var htbAckQueueCeil: kotlin.Float
      @kotlin.jvm.JvmName("getHtbAckQueueCeil")
        get() = _builder.htbAckQueueCeil
      @kotlin.jvm.JvmName("setHtbAckQueueCeil")
        set(value) {
    ...
    public var cakeQueueBandwidth: kotlin.Float
      @kotlin.jvm.JvmName("getCakeQueueBandwidth")
        get() = _builder.cakeQueueBandwidth
      @kotlin.jvm.JvmName("setCakeQueueBandwidth")
        set(value) {
    ...
    public var cakeAckFilterAggressive: kotlin.Boolean
      @kotlin.jvm.JvmName("getCakeAckFilterAggressive")
        get() = _builder.cakeAckFilterAggressive
      @kotlin.jvm.JvmName("setCakeAckFilterAggressive")
        set(value) {
    ...
    public var cakeManualRtt: kotlin.Float
      @kotlin.jvm.JvmName("getCakeManualRtt")
        get() = _builder.cakeManualRtt
      @kotlin.jvm.JvmName("setCakeManualRtt")
        set(value) {
