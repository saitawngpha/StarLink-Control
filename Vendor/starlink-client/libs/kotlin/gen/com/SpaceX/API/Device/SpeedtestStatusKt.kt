...
public object SpeedtestStatusKt {
  ...
  @kotlin.PublishedApi
    ...
    public var running: kotlin.Boolean
      @kotlin.jvm.JvmName("getRunning")
        get() = _builder.running
      @kotlin.jvm.JvmName("setRunning")
        set(value) {
    ...
    public var down: com.SpaceX.API.Device.SpeedtestStatus.Direction
      @kotlin.jvm.JvmName("getDown")
        get() = _builder.down
      @kotlin.jvm.JvmName("setDown")
        set(value) {
        _builder.down = value
      }
    /**
...
@kotlin.jvm.JvmName("clearThroughputsMbps")
      ...
      public var errValue: kotlin.Int
        @kotlin.jvm.JvmName("getErrValue")
          get() = _builder.errValue
        @kotlin.jvm.JvmName("setErrValue")
          set(value) {
