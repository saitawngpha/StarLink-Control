  ...
  public static final class Builder extends
    ...
    private void maybeForceBuilderInitialization() {
      if (com.google.protobuf.GeneratedMessage
        ...
        internalGetRouterSpeedtestFieldBuilder();
      }
    }
    @java.lang.Override
    ...
    public Builder mergeFrom(com.SpaceX.API.Device.SpeedTestResponse other) {
      ...
      if (java.lang.Float.floatToRawIntBits(other.getDownloadBps()) != 0) {
      ...
      if (java.lang.Float.floatToRawIntBits(other.getLatencyS()) != 0) {
        setLatencyS(other.getLatencyS());
      }
      if (java.lang.Float.floatToRawIntBits(other.getDownloadMbps()) != 0) {
        setDownloadMbps(other.getDownloadMbps());
      }
      if (java.lang.Float.floatToRawIntBits(other.getUploadMbps()) != 0) {
      ...
      if (java.lang.Float.floatToRawIntBits(other.getDownloadMbps1TcpConn()) != 0) {
        setDownloadMbps1TcpConn(other.getDownloadMbps1TcpConn());
      }
      if (java.lang.Float.floatToRawIntBits(other.getUploadMbps1TcpConn()) != 0) {
        setUploadMbps1TcpConn(other.getUploadMbps1TcpConn());
      }
      if (java.lang.Float.floatToRawIntBits(other.getDownloadMbps4TcpConn()) != 0) {
        setDownloadMbps4TcpConn(other.getDownloadMbps4TcpConn());
      }
      if (java.lang.Float.floatToRawIntBits(other.getUploadMbps4TcpConn()) != 0) {
        setUploadMbps4TcpConn(other.getUploadMbps4TcpConn());
      }
      if (java.lang.Float.floatToRawIntBits(other.getDownloadMbps16TcpConn()) != 0) {
        setDownloadMbps16TcpConn(other.getDownloadMbps16TcpConn());
      }
      if (java.lang.Float.floatToRawIntBits(other.getUploadMbps16TcpConn()) != 0) {
        setUploadMbps16TcpConn(other.getUploadMbps16TcpConn());
      }
      if (java.lang.Float.floatToRawIntBits(other.getDownloadMbps64TcpConn()) != 0) {
        setDownloadMbps64TcpConn(other.getDownloadMbps64TcpConn());
      }
      if (java.lang.Float.floatToRawIntBits(other.getUploadMbps64TcpConn()) != 0) {
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 122: {
              input.readMessage(
                  internalGetRouterSpeedtestFieldBuilder().getBuilder(),
                  extensionRegistry);
    ...
    public com.SpaceX.API.Device.SpeedTestStats.Builder getRouterSpeedtestBuilder() {
      bitField0_ |= 0x00000040;
      onChanged();
      return internalGetRouterSpeedtestFieldBuilder().getBuilder();
    }
    /**
     * <code>.SpaceX.API.Device.SpeedTestStats router_speedtest = 15 [json_name = "routerSpeedtest"];</code>
     */
