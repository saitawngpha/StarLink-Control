...
private static final long serialVersionUID = 0L;
  ...
  public enum Platform
    ...
    public static com.google.protobuf.Descriptors.EnumDescriptor
        getDescriptor() {
      return com.SpaceX.API.Device.ClientPlatform.getDescriptor().getEnumType(0);
    }
  ...
  public static final class Builder extends
    ...
    public Builder mergeFrom(com.SpaceX.API.Device.ClientPlatform other) {
      ...
      if (java.lang.Float.floatToRawIntBits(other.getMajorVersion()) != 0) {
        setMajorVersion(other.getMajorVersion());
      }
      if (java.lang.Float.floatToRawIntBits(other.getMinorVersion()) != 0) {
