...
private static final long serialVersionUID = 0L;
  ...
  public enum WifiLimitedReason
    ...
    public static com.google.protobuf.Descriptors.EnumDescriptor
        getDescriptor() {
      return com.SpaceX.API.Device.WifiGetClientHistoryResponse.getDescriptor().getEnumType(0);
    }
  ...
  public static final class Builder extends
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 34: {
              ...
              ensureThroughputLimitedIsMutable();
              while (input.getBytesUntilLimit() > 0) {
                throughputLimited_.addInt(input.readEnum());
              }
              input.popLimit(limit);
              break;
            } // case 34
    ...
    private com.google.protobuf.Internal.IntList throughputLimited_ = emptyIntList();
    private void ensureThroughputLimitedIsMutable() {
      if (!throughputLimited_.isModifiable()) {
