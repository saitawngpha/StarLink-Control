...
private static final long serialVersionUID = 0L;
  ...
  public static final class Builder extends
    ...
    public Builder mergeFrom(com.SpaceX.API.Device.TransceiverIFLoopbackTestResponse other) {
      ...
      if (java.lang.Float.floatToRawIntBits(other.getBerLoopbackTest()) != 0) {
        setBerLoopbackTest(other.getBerLoopbackTest());
      }
      if (java.lang.Float.floatToRawIntBits(other.getSnrLoopbackTest()) != 0) {
        setSnrLoopbackTest(other.getSnrLoopbackTest());
      }
      if (java.lang.Float.floatToRawIntBits(other.getRssiLoopbackTest()) != 0) {
