...
public final class MeshGrpc {
   ...
   */
  public static MeshBlockingV2Stub newBlockingV2Stub(
      io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<MeshBlockingV2Stub> factory =
      new io.grpc.stub.AbstractStub.StubFactory<MeshBlockingV2Stub>() {
        @java.lang.Override
        public MeshBlockingV2Stub newStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
          return new MeshBlockingV2Stub(channel, callOptions);
        }
      };
    return MeshBlockingV2Stub.newStub(factory, channel);
  }
   ...
   */
  public static final class MeshBlockingV2Stub
      extends io.grpc.stub.AbstractBlockingStub<MeshBlockingV2Stub> {
    private MeshBlockingV2Stub(
        io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      super(channel, callOptions);
    }

    @java.lang.Override
    protected MeshBlockingV2Stub build(
        io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      return new MeshBlockingV2Stub(channel, callOptions);
    }
    ...
    public io.grpc.stub.BlockingClientCall<com.SpaceX.API.Device.ToController, com.SpaceX.API.Device.FromController>
        meshStream() {
      return io.grpc.stub.ClientCalls.blockingBidiStreamingCall(
          getChannel(), getMeshStreamMethod(), getCallOptions());
    }
  }

  /**
   * A stub to allow clients to do limited synchronous rpc calls to service Mesh.
   */
