...
public final class UnlockServiceGrpc {
   ...
   */
  public static UnlockServiceBlockingV2Stub newBlockingV2Stub(
      io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<UnlockServiceBlockingV2Stub> factory =
      new io.grpc.stub.AbstractStub.StubFactory<UnlockServiceBlockingV2Stub>() {
        @java.lang.Override
        public UnlockServiceBlockingV2Stub newStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
          return new UnlockServiceBlockingV2Stub(channel, callOptions);
        }
      };
    return UnlockServiceBlockingV2Stub.newStub(factory, channel);
  }
   ...
   */
  public static final class UnlockServiceBlockingV2Stub
      extends io.grpc.stub.AbstractBlockingStub<UnlockServiceBlockingV2Stub> {
    private UnlockServiceBlockingV2Stub(
        io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      super(channel, callOptions);
    }

    @java.lang.Override
    protected UnlockServiceBlockingV2Stub build(
        io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      return new UnlockServiceBlockingV2Stub(channel, callOptions);
    }
    ...
    /**
     */
    public com.SpaceX.API.Device.Services.Unlock.StartUnlockResponse startUnlock(com.SpaceX.API.Device.Services.Unlock.StartUnlockRequest request) throws io.grpc.StatusException {
    ...
    /**
     */
    public com.SpaceX.API.Device.Services.Unlock.FinishUnlockResponse finishUnlock(com.SpaceX.API.Device.Services.Unlock.FinishUnlockRequest request) throws io.grpc.StatusException {
      return io.grpc.stub.ClientCalls.blockingV2UnaryCall(
  ...
  /**
   * A stub to allow clients to do limited synchronous rpc calls to service UnlockService.
   */
