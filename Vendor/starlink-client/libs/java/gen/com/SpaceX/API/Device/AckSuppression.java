...
private static final long serialVersionUID = 0L;
  ...
  public static final class Builder extends
    ...
    public Builder mergeFrom(com.SpaceX.API.Device.AckSuppression other) {
      ...
      if (java.lang.Float.floatToRawIntBits(other.getHtbAckQueueRate()) != 0) {
        setHtbAckQueueRate(other.getHtbAckQueueRate());
      }
      if (java.lang.Float.floatToRawIntBits(other.getHtbAckQueueCeil()) != 0) {
        setHtbAckQueueCeil(other.getHtbAckQueueCeil());
      }
      if (java.lang.Float.floatToRawIntBits(other.getCakeQueueBandwidth()) != 0) {
      ...
      if (java.lang.Float.floatToRawIntBits(other.getCakeManualRtt()) != 0) {
