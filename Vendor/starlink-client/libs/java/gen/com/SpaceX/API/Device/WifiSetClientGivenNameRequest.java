  ...
  public static final class Builder extends
    ...
    private void maybeForceBuilderInitialization() {
      if (com.google.protobuf.GeneratedMessage
        ...
        internalGetClientNameFieldBuilder();
        internalGetClientConfigFieldBuilder();
      }
    }
    @java.lang.Override
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 10: {
              input.readMessage(
                  internalGetClientNameFieldBuilder().getBuilder(),
                  extensionRegistry);
            ...
            case 18: {
              input.readMessage(
                  internalGetClientConfigFieldBuilder().getBuilder(),
                  extensionRegistry);
    ...
    @java.lang.Deprecated public com.SpaceX.API.Device.ClientName.Builder getClientNameBuilder() {
      bitField0_ |= 0x00000001;
      onChanged();
      return internalGetClientNameFieldBuilder().getBuilder();
    }
    /**
     * <code>.SpaceX.API.Device.ClientName client_name = 1 [json_name = "clientName", deprecated = true];</code>
     */
    ...
    public com.SpaceX.API.Device.ClientConfig.Builder getClientConfigBuilder() {
      bitField0_ |= 0x00000002;
      onChanged();
      return internalGetClientConfigFieldBuilder().getBuilder();
    }
    /**
     * <code>.SpaceX.API.Device.ClientConfig client_config = 2 [json_name = "clientConfig"];</code>
     */
