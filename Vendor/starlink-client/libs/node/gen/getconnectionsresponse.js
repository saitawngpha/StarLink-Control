  ...
  while (reader.nextField()) {
    ...
    case 1:
      ...
      reader.readMessage(value, function(message, reader) {
        jspb.Map.deserializeBinary(message, reader, jspb.BinaryReader.prototype.readStringRequireUtf8, jspb.BinaryReader.prototype.readMessage, proto.SpaceX.API.Device.GetConnectionsResponse.ServiceConnection.deserializeBinaryFromReader, "", new proto.SpaceX.API.Device.GetConnectionsResponse.ServiceConnection());
         });
      break;
    default:
      reader.skipField();
...
jspb.internal.public_for_gencode.serializeMapToBinary(
    message.getServicesMap(true),
    1,
    writer,
    jspb.BinaryWriter.prototype.writeString,
    jspb.BinaryWriter.prototype.writeMessage,
    proto.SpaceX.API.Device.GetConnectionsResponse.ServiceConnection.serializeBinaryToWriter);
  }
};
