  ...
  while (reader.nextField()) {
    ...
    case 1:
      ...
      reader.readMessage(value, function(message, reader) {
        jspb.Map.deserializeBinary(message, reader, jspb.BinaryReader.prototype.readStringRequireUtf8, jspb.BinaryReader.prototype.readMessage, proto.SpaceX.API.Device.PingResult.deserializeBinaryFromReader, "", new proto.SpaceX.API.Device.PingResult());
         });
      break;
    default:
      reader.skipField();
