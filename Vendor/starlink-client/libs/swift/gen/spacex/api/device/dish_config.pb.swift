...
nonisolated struct SpaceX_API_Device_DishConfig: Sendable {
...
nonisolated extension SpaceX_API_Device_DishConfig: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}snow_melt_mode\0\u{3}location_request_mode\0\u{3}level_dish_mode\0\u{3}power_save_start_minutes\0\u{3}power_save_duration_minutes\0\u{3}power_save_mode\0\u{3}swupdate_three_day_deferral_enabled\0\u{4}b\u{f}apply_snow_melt_mode\0\u{4}h\u{f}apply_location_request_mode\0\u{4}h\u{f}apply_level_dish_mode\0\u{4}h\u{f}apply_power_save_start_minutes\0\u{4}h\u{f}apply_power_save_duration_minutes\0\u{4}h\u{f}apply_power_save_mode\0\u{4}h\u{f}apply_swupdate_three_day_deferral_enabled\0")
