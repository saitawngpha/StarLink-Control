...
nonisolated extension SpaceX_API_Device_InflatedBasicServiceSet: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}bssid\0\u{1}ssid\0\u{3}mac_lan\0\u{3}iface_name\0\u{3}iface_type\0\u{1}channel\0\u{1}preference\0")
...
nonisolated extension SpaceX_API_Device_DhcpServer: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}domain\0\u{1}subnet\0\u{1}leases\0")
...
nonisolated extension SpaceX_API_Device_PoeStats: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}poe_state\0\u{3}poe_power\0\u{3}poe_faults_fast_overcurrent\0\u{3}poe_faults_slow_overcurrent\0\u{3}poe_faults_overvoltage\0\u{3}poe_faults_undervoltage\0")
...
nonisolated extension SpaceX_API_Device_WifiSoftwareUpdateStats: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}state\0\u{3}software_download_progress\0\u{3}seconds_since_get_target_versions\0")
