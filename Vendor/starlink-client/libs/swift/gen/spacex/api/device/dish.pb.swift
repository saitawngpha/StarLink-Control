...
nonisolated struct SpaceX_API_Device_StartDishSelfTestRequest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
nonisolated struct SpaceX_API_Device_StartDishSelfTestResponse: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
nonisolated extension SpaceX_API_Device_DishGetContextResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}device_info\0\u{3}obstruction_fraction\0\u{3}obstruction_valid_s\0\u{3}cell_id\0\u{3}pop_rack_id\0\u{3}seconds_to_slot_end\0\u{3}device_state\0\u{3}initial_satellite_id\0\u{3}initial_gateway_id\0\u{3}on_backup_beam\0\u{3}debug_telemetry_enabled\0\u{3}obstruction_current\0\u{3}pop_ping_drop_rate_15s_mean\0\u{3}pop_ping_latency_ms_15s_mean\0\u{3}seconds_since_last_1s_outage\0\u{3}seconds_since_last_2s_outage\0\u{3}seconds_since_last_5s_outage\0\u{3}seconds_since_last_15s_outage\0\u{3}seconds_since_last_60s_outage\0\u{3}obstruction_time\0\u{3}disablement_code\0\u{3}ku_mac_active_ratio\0")
...
nonisolated extension SpaceX_API_Device_DishOutage.Cause: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0UNKNOWN\0\u{1}BOOTING\0\u{1}STOWED\0\u{1}THERMAL_SHUTDOWN\0\u{1}NO_SCHEDULE\0\u{1}NO_SATS\0\u{1}OBSTRUCTED\0\u{1}NO_DOWNLINK\0\u{1}NO_PINGS\0\u{1}ACTUATOR_ACTIVITY\0\u{1}CABLE_TEST\0\u{1}SLEEPING\0\u{1}MOVING_WHILE_NOT_ALLOWED\0")
}
...
nonisolated extension SpaceX_API_Device_DishGetHistoryResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}current\0\u{4}h\u{f}pop_ping_drop_rate\0\u{3}pop_ping_latency_ms\0\u{3}downlink_throughput_bps\0\u{3}uplink_throughput_bps\0\u{2}\u{5}outages\0\u{c}m\u{f}\u{1}\u{c}n\u{f}\u{1}\u{c}o\u{f}\u{1}\u{c}p\u{f}\u{1}")
...
nonisolated extension SpaceX_API_Device_DishGetObstructionMapResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}num_rows\0\u{3}num_cols\0\u{1}snr\0\u{3}min_elevation_deg\0\u{3}max_theta_deg\0")
...
nonisolated extension SpaceX_API_Device_DishAlerts: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}motors_stuck\0\u{3}thermal_shutdown\0\u{3}thermal_throttle\0\u{3}unexpected_location\0\u{3}mast_not_near_vertical\0\u{3}slow_ethernet_speeds\0\u{1}roaming\0\u{3}install_pending\0\u{3}is_heating\0\u{3}power_supply_thermal_throttle\0\u{3}is_power_save_idle\0\u{3}moving_while_not_mobile\0\u{4}\u{2}dbf_telem_stale\0\u{3}moving_too_fast_for_policy\0\u{3}low_motor_current\0\u{3}lower_signal_than_predicted\0\u{3}slow_ethernet_speeds_100\0\u{b}moving_fast_while_not_aviation\0\u{c}\u{d}\u{1}")
...
nonisolated extension SpaceX_API_Device_SoftwareUpdateStats: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}software_update_state\0\u{3}software_update_progress\0")
...
nonisolated extension SpaceX_API_Device_StartDishSelfTestRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
...
nonisolated extension SpaceX_API_Device_StartDishSelfTestResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
...
nonisolated extension SpaceX_API_Device_DishSetConfigResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}updated_dish_config\0")
