...
nonisolated extension SpaceX_API_Device_User: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0NO_USER\0\u{1}GOD\0\u{1}LAN\0\u{1}CLOUD\0\u{1}FACTORY\0\u{1}ROUTER\0\u{1}GUEST_LAN\0\u{1}SENSITIVE_COMMANDING\0")
}
