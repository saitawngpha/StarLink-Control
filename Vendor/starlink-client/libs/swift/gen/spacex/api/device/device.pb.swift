...
nonisolated struct SpaceX_API_Device_DishSetEmcRequest: @unchecked Sendable {
  ...
  var amplitudeTaperOverride: UInt32 {
    get {_storage._amplitudeTaperOverride}
...
nonisolated extension SpaceX_API_Device_PositionSource: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0AUTO\0\u{1}NONE\0\u{1}UT_INFO\0\u{1}EXTERNAL\0\u{1}GPS\0\u{1}STARLINK\0\u{1}GNC_GPS\0\u{1}GNC_PNT\0\u{1}GNC_FUSED\0\u{1}GNC_RAW\0")
}
...
nonisolated extension SpaceX_API_Device_Request: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}id\0\u{4}\u{c}target_id\0\u{3}epoch_id\0\u{3}signed_request\0\u{2}Z\u{f}reboot\0\u{4}\u{2}speed_test\0\u{3}get_status\0\u{1}authenticate\0\u{3}get_next_id\0\u{3}get_history\0\u{3}get_device_info\0\u{3}get_ping\0\u{3}set_trusted_keys\0\u{3}factory_reset\0\u{3}get_log\0\u{3}set_sku\0\u{1}update\0\u{3}get_network_interfaces\0\u{3}ping_host\0\u{3}get_location\0\u{4}\u{2}get_heap_dump\0\u{3}restart_control\0\u{1}fuse\0\u{3}get_persistent_stats\0\u{3}get_connections\0\u{4}\u{4}start_speedtest\0\u{3}get_speedtest_status\0\u{3}report_client_speedtest\0\u{3}initiate_remote_ssh\0\u{3}self_test\0\u{3}set_test_mode\0\u{3}software_update\0\u{3}enable_debug_telem\0\u{3}iq_capture\0\u{3}get_radio_stats\0\u{1}time\0\u{3}run_iperf_server\0\u{3}tcp_connectivity_test\0\u{3}udp_connectivity_test\0\u{4}&sensitive_request\0\u{4}\\\u{e}dish_stow\0\u{3}dish_get_context\0\u{4}\u{4}dish_set_emc\0\u{3}dish_get_obstruction_map\0\u{3}dish_get_emc\0\u{3}dish_set_config\0\u{3}dish_get_config\0\u{3}start_dish_self_test\0\u{3}dish_power_save\0\u{3}dish_inhibit_gps\0\u{3}dish_get_data\0\u{4}\u{2}dish_clear_obstruction_map\0\u{3}dish_set_max_power_test_mode\0\u{3}dish_activate_rssi_scan\0\u{3}dish_get_rssi_scan_result\0\u{3}dish_factory_reset\0\u{3}reset_button\0\u{4}S\u{f}wifi_set_config\0\u{3}wifi_get_clients\0\u{3}wifi_setup\0\u{4}\u{4}wifi_get_ping_metrics\0\u{4}\u{2}wifi_get_config\0\u{4}\u{3}wifi_set_mesh_device_trust\0\u{3}wifi_set_mesh_config\0\u{4}\u{2}wifi_get_client_history\0\u{3}wifi_set_aviation_conformed\0\u{3}wifi_set_client_given_name\0\u{3}wifi_self_test\0\u{3}wifi_calibration_mode\0\u{3}wifi_guest_info\0\u{3}wifi_rf_test\0\u{4}\u{3}wifi_get_firewall\0\u{3}wifi_toggle_poe_negotiation\0\u{3}wifi_factory_test_command\0\u{3}wifi_start_local_telem_proxy\0\u{3}wifi_run_self_test\0\u{3}wifi_backhaul_stats\0\u{3}wifi_toggle_umbilical_mode\0\u{4}K\u{f}transceiver_if_loopback_test\0\u{4}\u{2}transceiver_get_status\0\u{3}transceiver_get_telemetry\0\u{4}d\u{f}start_unlock\0\u{3}finish_unlock\0\u{4}g\u{f}get_diagnostics\0\u{c}z\u{f}\u{1}\u{c}A\u{10}\u{1}\u{c}B\u{10}\u{1}\u{c}`\u{1f}\u{1}\u{c}C/\u{1}\u{c}F/\u{1}\u{c}B2\u{1}")
...
nonisolated extension SpaceX_API_Device_Response: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}id\0\u{1}status\0\u{3}api_version\0\u{2}f\u{f}reboot\0\u{4}\u{2}speed_test\0\u{3}get_device_info\0\u{4}\u{2}get_next_id\0\u{4}\u{3}get_ping\0\u{3}set_trusted_keys\0\u{3}factory_reset\0\u{3}get_log\0\u{3}set_sku\0\u{1}update\0\u{3}get_network_interfaces\0\u{3}ping_host\0\u{3}get_location\0\u{4}\u{2}get_heap_dump\0\u{3}restart_control\0\u{1}fuse\0\u{4}\u{2}get_connections\0\u{4}\u{4}start_speedtest\0\u{3}get_speedtest_status\0\u{3}report_client_speedtest\0\u{3}initiate_remote_ssh\0\u{3}self_test\0\u{3}set_test_mode\0\u{3}software_update\0\u{3}enable_debug_telem\0\u{3}get_radio_stats\0\u{2}\u{2}time\0\u{3}run_iperf_server\0\u{4}D\u{f}dish_stow\0\u{3}dish_get_context\0\u{3}dish_get_status\0\u{3}dish_authenticate\0\u{3}dish_get_history\0\u{3}dish_set_emc\0\u{3}dish_get_obstruction_map\0\u{3}dish_get_emc\0\u{3}dish_set_config\0\u{3}dish_get_config\0\u{3}start_dish_self_test\0\u{3}dish_inhibit_gps\0\u{4}\u{2}dish_clear_obstruction_map\0\u{4}\u{3}dish_set_max_power_test_mode\0\u{3}dish_activate_rssi_scan\0\u{3}dish_get_rssi_scan_result\0\u{3}dish_factory_reset\0\u{3}reset_button\0\u{4}S\u{f}wifi_set_config\0\u{3}wifi_get_clients\0\u{3}wifi_setup\0\u{3}wifi_get_status\0\u{3}wifi_authenticate\0\u{3}wifi_get_history\0\u{3}wifi_get_ping_metrics\0\u{4}\u{2}wifi_get_config\0\u{4}\u{3}wifi_set_mesh_device_trust\0\u{3}wifi_set_mesh_config\0\u{4}\u{2}wifi_get_client_history\0\u{3}wifi_self_test\0\u{4}\u{4}wifi_guest_info\0\u{3}wifi_rf_test\0\u{3}wifi_get_persistent_stats\0\u{4}\u{2}wifi_get_firewall\0\u{3}wifi_factory_test_command\0\u{3}wifi_backhaul_stats\0\u{4}O\u{f}transceiver_if_loopback_test\0\u{4}\u{2}transceiver_get_status\0\u{3}transceiver_get_telemetry\0\u{4}d\u{f}start_unlock\0\u{3}finish_unlock\0\u{4}g\u{f}wifi_get_diagnostics\0\u{3}dish_get_diagnostics\0\u{c}z\u{f}\u{1}\u{c}B\u{10}\u{1}\u{c}^\u{1f}\u{1}\u{c}i\u{1f}\u{1}\u{c}@/\u{1}\u{c}C/\u{1}\u{c}F/\u{1}\u{c}C2\u{1}")
...
nonisolated extension SpaceX_API_Device_Event: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{4}y.wifi_new_client_connected\0\u{3}wifi_account_bonding\0\u{3}wifi_new_peer\0\u{3}wifi_cloud_status\0")
...
nonisolated extension SpaceX_API_Device_GetLogResponse.Logs: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}syslog\0\u{1}dmesg\0\u{3}kernel_panic\0\u{3}mtk_eth_procs\0")
...
nonisolated extension SpaceX_API_Device_SpeedTestStats: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}upload_mbps\0\u{3}download_mbps\0\u{3}latency_ms\0\u{3}start_time\0\u{3}upload_start_time\0\u{3}download_start_time\0\u{1}target\0\u{3}tcp_streams\0")
...
nonisolated extension SpaceX_API_Device_GetLocationResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}lla\0\u{2}\u{2}source\0\u{3}sigma_m\0\u{b}ecef\0\u{c}\u{2}\u{1}")
...
nonisolated extension SpaceX_API_Device_DishGetDiagnosticsResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}id\0\u{3}hardware_version\0\u{3}software_version\0\u{3}utc_offset_s\0\u{1}alerts\0\u{3}disablement_code\0\u{3}hardware_self_test\0\u{1}location\0")
...
nonisolated extension SpaceX_API_Device_DishGetDiagnosticsResponse.DisablementCode: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0UNKNOWN\0\u{1}OKAY\0\u{1}NO_ACTIVE_ACCOUNT\0\u{1}TOO_FAR_FROM_SERVICE_ADDRESS\0\u{1}IN_OCEAN\0\u{1}INVALID_COUNTRY\0\u{1}BLOCKED_COUNTRY\0\u{1}DATA_OVERAGE_SANDBOX_POLICY\0\u{1}CELL_IS_DISABLED\0\u{1}UNLICENSED_COUNTRY\0")
}
...
nonisolated extension SpaceX_API_Device_DishGetDiagnosticsResponse.Location: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}enabled\0\u{1}latitude\0\u{1}longitude\0\u{3}altitude_meters\0")
