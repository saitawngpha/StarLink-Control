...
nonisolated extension SpaceX_API_Satellites_Network_UtDisablementCode: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0UNKNOWN_STATE\0\u{1}OKAY\0\u{1}NO_ACTIVE_ACCOUNT\0\u{1}TOO_FAR_FROM_SERVICE_ADDRESS\0\u{1}IN_OCEAN\0\u{1}INVALID_COUNTRY\0\u{1}BLOCKED_COUNTRY\0\u{1}DATA_OVERAGE_SANDBOX_POLICY\0\u{1}CELL_IS_DISABLED\0\u{1}UNLICENSED_COUNTRY\0")
}
