...
const file_spacex_api_device_wifi_proto_rawDesc = "" +
	...
	"\x06client\x18\x01 \x01(\v2\x1d.SpaceX.API.Device.WifiClientR\x06client\"\xba\x1b\n" +
	"\n" +
	"WifiClient\x12\x12\n" +
	...
	"\x12dhcp_lease_renewed\x18/ \x01(\bR\x10dhcpLeaseRenewed\x12%\n" +
	...
	"\ffqcodel_info\x18, \x01(\v2).SpaceX.API.Device.WifiClient.FqcodelInfoR\vfqcodelInfo\x1a\x89\x04\n" +
	"\aRxStats\x12\x14\n" +
	...
	"\x12rate_mbps_last_15s\x18\x0f \x01(\x02R\x0frateMbpsLast15s\x12\x10\n" +
	...
	"\fdeqs_dropped\x18\v \x01(\x04R\vdeqsDropped\"M\n" +
	"\tInterface\x12\v\n" +
	...
	"R+inconsistent_2ghz_antennae_performance_15dbR+inconsistent_5ghz_antennae_performance_15dbR#poor_2ghz_antennae_performance_80dbR#poor_5ghz_antennae_performance_80db\"\xca\f\n" +
	"\x15WifiGetStatusResponse\x12>\n" +
	"\vdevice_info\x18\x03 \x01(\v2\x1d.SpaceX.API.Device.DeviceInfoR\n" +
	"deviceInfo\x12A\n" +
	"\fdevice_state\x18\x04 \x01(\v2\x1e.SpaceX.API.Device.DeviceStateR\vdeviceState\x124\n" +
	"\x16captive_portal_enabled\x18\x01 \x01(\bR\x14captivePortalEnabled\x12)\n" +
	...
	"\x15software_update_stats\x18\x81\b \x01(\v2*.SpaceX.API.Device.WifiSoftwareUpdateStatsR\x13softwareUpdateStatsJ\x04\b\x02\x10\x03J\x04\b\x05\x10\x06J\x04\b\x06\x10\aJ\x04\b\a\x10\bJ\x06\b\xe9\a\x10\xea\aJ\x06\b\xea\a\x10\xeb\aJ\x06\b\xee\a\x10\xef\aJ\x06\b\xef\a\x10\xf0\a\"V\n" +
